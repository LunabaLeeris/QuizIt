...
public class QuestionSelectionPage extends JLayeredPane implements MouseListener {
    ...
    public void adjustComponents(){
        ...
        questionButtonType.get("tt").setBackground(new Color(63, 82, 54));
    ...
    public void initializeHashMap(){
        ...
        questionPanelColor.put("mc", new Color(63, 82, 54));questionPanelColor.put("arm", new Color(63, 82, 54));
        questionPanelColor.put("fb", new Color(63, 82, 54));questionPanelColor.put("tf", new Color(63, 82, 54));
        questionPanelColor.put("wj", new Color(63, 82, 54));questionPanelColor.put("id", new Color(63, 82, 54));
        questionPanelColor.put("tt", new Color(63, 82, 54));questionPanelColor.put("al", new Color(63, 82, 54));
        questionPanelColor.put("cs", new Color(63, 82, 54));questionPanelColor.put("aatrm", new Color(63, 82, 54));
    ...
    public void adjustQType(){
        for (JPanel item: questionButtonType.values()){
            item.setBackground(new Color(63, 82, 54));
        }
    }
    ...
    public void setOff(String key){
        ...
        questionButtonType.get(key).setBackground(new Color(63, 82, 54));
        questionPanelColor.put(key, new Color(63, 82, 54));
    }
...
// -------------------MOUSE LISTENER STUFF------------------------
        ...
        if (added) {
            ...
            if (e.getSource() == update) {
                if (validateMinMax()) {
                    ...
                    questionButtonType.get("cs").setBackground(new Color(63, 82, 54));
                    questionPanelColor.put("cs", new Color(63, 82, 54));
                    this.repaint();
                }
            }
        }
    ...
    public void mouseReleased(MouseEvent e) {
        if (e.getSource() == questionButtonType.get("arm")){
            questionButtonType.get("arm").setBackground(new Color(63, 82, 54));
        }
    }
            ...
            for (String key: questionButtonType.keySet()) {
                if (e.getSource() == questionButtonType.get(key)) {
                    if (questionTypes.get(key)) {
                        ...
                        questionButtonType.get(key).setBackground(new Color(104, 141, 96));
                    }
